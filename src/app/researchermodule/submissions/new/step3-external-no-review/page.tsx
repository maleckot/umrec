// app/researchermodule/submissions/new/step3-external-no-review/page.tsx
'use client';
...
export default function Step3ExternalNoReview() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('step3ExternalNoReviewData');
    if (saved) {
      try {
        const parsedData = JSON.parse(saved);
        setFormData({ ...parsedData, uploadedFile: null });
      } catch (error) {
        console.error('Error loading Step 3 External No Review data:', error);
      }
    }
  ...
  useEffect(() => {
    ...
    saveTimeoutRef.current = setTimeout(() => {
      ...
      localStorage.setItem('step3ExternalNoReviewData', JSON.stringify(dataToSave));
      console.log('💾 Step 3 External No Review auto-saved');
    }, 1000);
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#071139] mb-1" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                    Non-UMak Applicants (Research Not Yet Reviewed by External Research Ethics Committee/Board)
                  </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              <div>
                <label className="block text-sm sm:text-base font-bold mb-3 text-[#071139]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                  Upload the <span className="font-bold">Consolidated Files for Research Request</span>
                </label>
                ...
                <div className="relative">
                  <input
                    ...
                    className="hidden"
                    accept=".pdf"
                    // REMOVED required attribute - validation handled in handleSubmit
                  />
