        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-md p-8 md:p-12">
            ...
            <div className="text-center mb-10">
              <h1 className="text-4xl font-bold mb-4 text-[#1E293B]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                Submit Request For Ethics Review
              </h1>
              <p className="text-lg text-[#475569]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
            ...
            {/* Introduction */}
            <div className="mb-10">
              <p className="text-[#475569] mb-8 leading-relaxed" style={{ fontFamily: 'Metropolis, sans-serif' }}>
              ...
              <h2 className="text-2xl font-bold mb-6 text-[#1E293B]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                Required Documents and Information for Ethics Review:
              </h2>

              {/* Required Documents List - Simple Style */}
              <div className="space-y-4 mb-8">
                {requiredDocuments.map((doc, index) => (
                  <div key={index} className="flex items-start gap-3 bg-[#F3F4F6] p-4 rounded-xl">
                    <div className="w-8 h-8 bg-[#1E293B] text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                      {index + 1}
                    </div>
                    <p className="text-[#1E293B] pt-1 flex-1" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                      {doc.text}
                    </p>
                    {doc.hasPdf && (
                      <a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#071139] hover:bg-[#15235C] text-white rounded-lg transition-colors font-semibold text-sm flex-shrink-0"
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-l-4 border-[#FFD700] p-6 rounded-lg mb-6">
                <h3 className="font-bold text-lg mb-4 text-[#1E293B]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                  Formatting Guidelines for Documents:
                </h3>
                <ul className="space-y-2 text-[#475569]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-[#3B82F6] p-6 rounded-lg mb-6">
                <h3 className="font-bold text-lg mb-3 text-[#1E293B]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                  For External Research (Non-UMak):
                </h3>
                <p className="text-[#475569]" style={{ fontFamily: 'Metropolis, sans-serif' }}>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-l-4 border-[#FFD700] p-6 rounded-lg">
                ...
                <p className="text-[#475569] mb-4" style={{ fontFamily: 'Metropolis, sans-serif' }}>
            ...
            <div className="flex justify-center pt-6 border-t-2 border-gray-200">
              <button
                ...
                className="px-12 py-4 bg-[#071139] text-[#F0E847] text-lg font-bold rounded-lg hover:bg-[#1C2C6B] transition-colors cursor-pointer shadow-lg"
                style={{ fontFamily: 'Metropolis, sans-serif' }}
              >
                Make a Submission
              </button>
