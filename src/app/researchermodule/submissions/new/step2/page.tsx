...
style={{ fontFamily: 'Metropolis, sans-serif', color: '#071139' }}
                    ...
                    {/* Navigation Buttons */}
              <div className="flex flex-col sm:flex-row justify-between gap-4 pt-8 mt-8 border-t-2 border-gray-200">
                <button
                  type="button"
                  onClick={handleBack}
                  className="px-8 py-3 bg-gray-500 text-white rounded-xl hover:bg-gray-600 transition-all duration-300 font-bold shadow-lg"
                  style={{ fontFamily: 'Metropolis, sans-serif' }}
