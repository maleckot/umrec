// app/researchermodule/submissions/revision/step4-external/page.tsx
'use client';
...
export default function RevisionStep4ExternalSummary() {
  ...
  const [reviewerComments] = useState(
    'Please review all updated information carefully before resubmitting. Ensure all changes requested by the reviewer have been addressed.'
  );

  useEffect(() => {
    // Load all data from localStorage (revision versions)
    const data1 = localStorage.getItem('revisionStep1Data');
    const data2 = localStorage.getItem('revisionStep2ExternalData');
    const data3Reviewed = localStorage.getItem('revisionStep3ExternalData');
    const data3NoReview = localStorage.getItem('revisionStep3ExternalNoReviewData');
        ...
        <div className="max-w-[1400px] mx-auto">
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm sm:text-base text-gray-600" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                    Please review all information before resubmitting
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 p-6 sm:p-8 md:p-10 lg:p-12">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              {step1Data && (
                <div className="bg-gradient-to-r from-orange-500/5 to-orange-600/5 rounded-xl p-4 sm:p-6 border-l-4 border-orange-500 relative">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-orange-700" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                      Please ensure all revised information above is correct before resubmitting. The committee will review your updated application to verify all requested changes have been addressed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 pt-8 border-t-2 border-gray-200">
                ...
                <button
                  ...
                  className="w-full sm:w-auto group relative px-8 sm:px-12 py-3 sm:py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl hover:scale-105 overflow-hidden order-1 sm:order-2"
                  style={{ fontFamily: 'Metropolis, sans-serif' }}
