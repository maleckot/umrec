  ...
  export default function RevisionStep3() {
    ...
    const searchParams = useSearchParams(); // ✅ USE REACT HOOK
    const submissionId = searchParams.get('id');
    const docId = searchParams.get('docId');
    const [loadingComments, setLoadingComments] = useState(true);
    const [revisionComments, setRevisionComments] = useState('Please expand the introduction section to provide more context about your research. Also ensure all methodology sections are clearly detailed with specific procedures.');
          ...
          try {
            ...
            if (docId) {
              ...
              if (verification?.feedback_comment) {
                ...
                setRevisionComments('Please review and update your research protocol based on the feedback provided.');
              }
            } else {
              ...
              if (submission?.feedback_comments) {
                setRevisionComments(submission.feedback_comments);
              } else {
    ...
    }, [submissionId, docId]); // ✅ FIXED: Only ONE useEffect!
