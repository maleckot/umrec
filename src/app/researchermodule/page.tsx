            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-4xl font-bold" style={{ fontFamily: 'Metropolis, sans-serif', color: '#101C50' }}>
                    {stats.active}
                  </p>
                </div>
              </div>
            ...
            {currentSubmission && (
              <>
                <div className="mb-12">
                  ...
                  <p className="text-lg mb-8" style={{ fontFamily: 'Metropolis, sans-serif' }}>
            ...
            <div>
              ...
              <div className="flex gap-2 md:gap-4 mb-6 border-b border-gray-300 overflow-x-auto">
                <button
                  ...
                  className={`px-3 md:px-4 py-2 text-sm md:text-base font-medium transition-colors whitespace-nowrap ${activeTab === 'all'
                ...
                <button
                  ...
                  className={`px-3 md:px-4 py-2 text-sm md:text-base font-medium transition-colors whitespace-nowrap ${activeTab === 'revision'
                    ? 'border-b-2 border-[#101C50] text-[#101C50]'
                    : 'text-gray-600 hover:text-[#101C50]'
                    }`}
                  style={{ fontFamily: 'Metropolis, sans-serif' }}
                ...
                <button
                  ...
                  className={`px-3 md:px-4 py-2 text-sm md:text-base font-medium transition-colors whitespace-nowrap ${activeTab === 'pending'
                    ? 'border-b-2 border-[#101C50] text-[#101C50]'
                    : 'text-gray-600 hover:text-[#101C50]'
                    }`}
                  style={{ fontFamily: 'Metropolis, sans-serif' }}
                ...
                <button
                  ...
                  className={`px-3 md:px-4 py-2 text-sm md:text-base font-medium transition-colors whitespace-nowrap ${activeTab === 'approved'
                    ? 'border-b-2 border-[#101C50] text-[#101C50]'
                    : 'text-gray-600 hover:text-[#101C50]'
                    }`}
                  style={{ fontFamily: 'Metropolis, sans-serif' }}
              ...
              <div className="space-y-4">
                {filteredSubmissions.length === 0 ? (
                  ...
                  filteredSubmissions.map((submission) => {
                    // Filter out consolidated_application documents
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex items-start gap-4 flex-1">
                              ...
                              <div className="flex-1">
                                <h4 className="font-bold text-lg text-[#101C50] mb-1" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                                  {getDocumentTypeLabel(doc.fileType)}
                                </h4>
                                <p className="text-base text-gray-600 mb-2" style={{ fontFamily: 'Metropolis, sans-serif' }}>
                            ...
                            <button
                              ...
                              className={`px-8 py-2.5 text-white text-base rounded-full transition-colors cursor-pointer flex-shrink-0 ${docStatusInfo.buttonColor}`}
