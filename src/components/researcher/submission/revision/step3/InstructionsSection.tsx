    ...
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500 p-4 sm:p-6 rounded-xl shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed mb-4 font-medium" style={{ fontFamily: 'Metropolis, sans-serif' }}>
          ...
          <div className="mt-4 pt-4 border-t border-blue-200">
            <p className="text-xs sm:text-sm font-bold text-[#071139] mb-2" style={{ fontFamily: 'Metropolis, sans-serif' }}>
              Available Formatting Options:
            </p>
            <ul className="text-xs sm:text-sm text-gray-700 space-y-1 font-medium" style={{ fontFamily: 'Metropolis, sans-serif' }}>
