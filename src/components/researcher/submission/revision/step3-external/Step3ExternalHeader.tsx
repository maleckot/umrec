...
export default function Step3ExternalHeader({ onBack }: HeaderProps) {
  return (
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm sm:text-base text-gray-700 font-bold" style={{ fontFamily: 'Metropolis, sans-serif' }}>
