...
const ConsentFormSection = ({ data, onEdit, getLabel }: Props) => {
  return (
    <div className="bg-gradient-to-r from-orange-500/5 to-orange-600/5 rounded-xl p-4 sm:p-6 border-l-4 border-orange-500">
      ...
      <div>
        <p className="text-xs sm:text-sm text-gray-500 font-bold mb-1" style={{ fontFamily: 'Metropolis, sans-serif' }}>Participant Type</p>
        <p className="text-sm sm:text-base text-[#071139] font-bold" style={{ fontFamily: 'Metropolis, sans-serif' }}>
          {getLabel(data?.consentType)}
        </p>
      </div>
    </div>
  );
