'use client';
import { Users, Plus, X, User, PenTool, AlertCircle } from 'lucide-react';
...
interface ResearchTeamMembersProps {
...
export default function ResearchTeamMembers({ 
  researchers, 
  errors, 
  addResearcher, 
  removeResearcher, 
  updateResearcher 
}: ResearchTeamMembersProps) {
